...
INPUT_SEQS="../classifiers/gtdb-214-seqs.qza"
INPUT_TAX="../classifiers/gtdb-214-tax.qza"
...
EXTRACTED_SEQS="${RESULTS}/gtdb-214-extracted-seqs.qza"
TRAINED_CLASSIFIER="${RESULTS}/gtdb-214-classifier.qza"
FINAL_TAXONOMY="${RESULTS}/gtdb-taxonomy.qza"
FINAL_TAXONOMY_TSV="${EXPORTED}/taxonomy.tsv"
